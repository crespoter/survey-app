...
public class Completed_Surveys extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, ipclass.url+"/api/getquestionnaire/createdByUser/expired/"+(new PrefManager(container.getContext()).getuserId()), new Response.Listener<String>() {
